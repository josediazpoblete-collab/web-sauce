...
const PRODUCTOS_RESPALDO = [
  ...
  { id:17, cat:"ensaladas",  name:"Ensalada chilena",       price:2490, unit:"250g" },
  { id:18, cat:"ensaladas",  name:"Ensalada papa-mayo",     price:2690, unit:"250g" },
  { id:19, cat:"fiambres",   name:"Jamón pierna",           price:5990, unit:"kg" },
  { id:20, cat:"fiambres",   name:"Queso gauda",            price:7490, unit:"kg" },
  { id:21, cat:"fiambres",   name:"Mortadela",              price:3990, unit:"kg" },
  { id:22, cat:"pan",        name:"Hallulla",               price:1500, unit:"kg" },
  { id:23, cat:"pan",        name:"Marraqueta",             price:1500, unit:"kg" },
  { id:24, cat:"pan",        name:"Tortilla de rescoldo",   price:1990, unit:"un" },
];
...
function parseCSV(text) {
  ...
  return lines.slice(1).map(line => {
    ...
    return row;
  }).filter(r => r.nombre && r.disponible?.toUpperCase()==="SI").map(r => ({
    id:    Number(r.id),
